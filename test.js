...
var myPhone0 = new mobile_1.Mobile('Nokia', '3210', 'Nokia', 0.016, 'grey', false, 0, 50);
var myPhone1 = new mobile_1.Mobile('iPhone', '3G', 'Apple', 8, 'silver', false, 1, 150);
var myPhone2 = new mobile_1.Mobile('Galaxy', '10', 'Samsung', 16, 'black', true, 2, 350);
var myPhone3 = new mobile_1.Mobile('Xiaomi', 'Mi 11', 'Xiaomi', 64, 'blue', true, 2, 700);
...
var myPhone4 = new mobile_1.Mobile('iPhone', '12 Pro', 'Apple', 256, 'purple', true, 4, 1000);
